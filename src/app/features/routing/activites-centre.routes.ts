  ...
  withMenuPermission(
    ...
    data: {
      ...
      createFields: [
        ...
        F('tauxProgressionApprentissageLecture', 'Taux de progression lecture', 'text'),
        F('tauxProgressionApprentissageEcriture', 'Taux de progression écriture', 'text'),
        F('tauxProgressionApprentissageCalcul', 'Taux de progression calcul', 'text'),
        F('tauxProgressionApprentissageCvc', 'Taux de progression CVC', 'text'),
      ],
    },
  },
