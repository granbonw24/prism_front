...
export const REFERENTIEL_ROUTE_DATA: ReferentielRouteData[] = [
  ...
  {
    path: 'organisation-faitiere',
    title: 'Organisations faîtières',
    menuGroup: 'others',
    apiPath: '/api/organisation-faitiere',
    createFields: [
      F('sigleOrganisationFaitiere', 'Sigle', 'text', { required: true, maxLength: 20 }),
      F('libelleOrganisationFaitiere', 'Structure', 'text', { required: true, maxLength: 250 }),
      F('pointFocal', 'Point focal', 'text', { maxLength: 150 }),
      F('fonctionPointFocal', 'Fonction', 'text', { maxLength: 150 }),
      F('contacts', 'Contacts', 'text', { maxLength: 250 }),
      F('courriel', 'Courriel', 'text', { maxLength: 250 }),
    ],
    columnLabels: {
      sigleOrganisationFaitiere: 'Sigle',
      libelleOrganisationFaitiere: 'Structure',
      pointFocal: 'Point focal',
      fonctionPointFocal: 'Fonction',
      contacts: 'Contacts',
      courriel: 'Courriel',
      codeOrganisationFaitiere: 'Code',
    },
    listColumnKeys: [
      'sigleOrganisationFaitiere',
      'libelleOrganisationFaitiere',
      'pointFocal',
      'fonctionPointFocal',
      'contacts',
      'courriel',
  ...
  },
  {
    ...
    title: 'Types SIE',
    menuGroup: 'pedagogie',
    apiPath: '/api/TypeSies',
    createFields: [
      F('libelleTypeSie', 'Libellé', 'text', {
        required: true,
        maxLength: 50,
      }),
    ],
